 ...
 *         &lt;element name="options" type="{http://dto16.api.echosign}DisableWidgetOptions"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "disableWidget")
public class DisableWidget {
    ...
    @XmlElement(required = true, nillable = true)
    protected DisableWidgetOptions options;
     ...
     * @return
     *     possible object is
     *     {@link DisableWidgetOptions }
     *     
     */
    public DisableWidgetOptions getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(DisableWidgetOptions value) {
        this.options = value;
    }
