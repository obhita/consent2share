 ...
 *         &lt;element name="options" type="{http://dto20.api.echosign}DocumentEventsForUserOptions"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getDocumentEventsForUser")
public class GetDocumentEventsForUser {
    ...
    @XmlElement(required = true, nillable = true)
    protected DocumentEventsForUserOptions options;
     ...
     * @return
     *     possible object is
     *     {@link DocumentEventsForUserOptions }
     *     
     */
    public DocumentEventsForUserOptions getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(DocumentEventsForUserOptions value) {
        this.options = value;
    }
