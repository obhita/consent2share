 ...
 *         &lt;element name="includeScalingTypes" type="{http://dto14.api.echosign}IncludeScalingTypes" minOccurs="0"/>
...
public class GetDocumentImageUrlsOptions {
    ...
    protected IncludeScalingTypes includeScalingTypes;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the includeScalingTypes property.
     * 
     * @return
     *     possible object is
     *     {@link IncludeScalingTypes }
     *     
     */
    public IncludeScalingTypes getIncludeScalingTypes() {
        return includeScalingTypes;
    }

    /**
     * Sets the value of the includeScalingTypes property.
     * 
     * @param value
     *     allowed object is
     *     {@link IncludeScalingTypes }
     *     
     */
    public void setIncludeScalingTypes(IncludeScalingTypes value) {
        this.includeScalingTypes = value;
    }
