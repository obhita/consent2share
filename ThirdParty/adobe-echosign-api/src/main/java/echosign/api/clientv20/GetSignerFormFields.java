 ...
 *         &lt;element name="options" type="{http://dto19.api.echosign}GetSignerFormFieldsOptions"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getSignerFormFields")
public class GetSignerFormFields {
    ...
    @XmlElement(required = true, nillable = true)
    protected GetSignerFormFieldsOptions options;
     ...
     * @return
     *     possible object is
     *     {@link GetSignerFormFieldsOptions }
     *     
     */
    public GetSignerFormFieldsOptions getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(GetSignerFormFieldsOptions value) {
        this.options = value;
    }
