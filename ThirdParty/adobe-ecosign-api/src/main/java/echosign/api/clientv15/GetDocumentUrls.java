 ...
 *         &lt;element name="options" type="{http://dto14.api.echosign}GetDocumentUrlsOptions"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getDocumentUrls")
public class GetDocumentUrls {
    ...
    @XmlElement(required = true, nillable = true)
    protected GetDocumentUrlsOptions options;
     ...
     * @return
     *     possible object is
     *     {@link GetDocumentUrlsOptions }
     *     
     */
    public GetDocumentUrlsOptions getOptions() {
        return options;
    }
     ...
     *     
     */
    public void setOptions(GetDocumentUrlsOptions value) {
        this.options = value;
    }
