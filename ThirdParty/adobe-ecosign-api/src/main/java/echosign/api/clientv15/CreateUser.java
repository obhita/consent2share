 ...
 *         &lt;element name="userInfo" type="{http://dto.api.echosign}UserCreationInfo"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CreateUser {
    ...
    @XmlElement(required = true, nillable = true)
    protected UserCreationInfo userInfo;
     ...
     *     
     */
    public UserCreationInfo getUserInfo() {
        return userInfo;
    }
     ...
     *     
     */
    public void setUserInfo(UserCreationInfo value) {
        this.userInfo = value;
    }
