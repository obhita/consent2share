...
public class CopyStream implements Runnable
{
  ...
  public CopyStream(Direction direction, InputStream inputStream, OutputStream outputStream, PrintStream logPrintStream, boolean prettyPrint) throws UnsupportedEncodingException
  {
    this.direction = direction;
    this.message = (direction == Direction.CLIENT2SERVER) ? SoapProxy.FROM_CLIENT_TO_SERVER : SoapProxy.FROM_SERVER_TO_CLIENT;
    this.inputReader = new BufferedHttpStreamReader(inputStream);
