...
public class RetrieveDocumentSetResponseFilterTest {
	...
	@InjectMocks
	RetrieveDocumentSetResponseFilter retrieveDocumentSetResponseFilter
		=new RetrieveDocumentSetResponseFilter(converter,xdsbErrorFactory);

	@Test(expected=XdsbRepositoryAdapterException.class)
	public void testFilterByPatientAndAuthor() throws XdsbRepositoryAdapterException {
		
		RetrieveDocumentSetResponse response=mock(RetrieveDocumentSetResponse.class);
		String patientId="1";
		String authorNPI="2";
		...
		retrieveDocumentSetResponseFilter.filterByPatientAndAuthor(response, patientId, authorNPI);
	}
	
	@Test
	public void testFilterByPatientAndAuthor2() throws XdsbRepositoryAdapterException {
