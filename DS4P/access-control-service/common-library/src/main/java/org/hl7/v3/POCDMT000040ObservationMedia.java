...
@XmlType(name="POCD_MT000040.ObservationMedia", propOrder={"realmCode", "typeId", "templateId", "id", "languageCode", "value", "subject", "specimen", "performer", "author", "informant", "participant", "entryRelationship", "reference", "precondition"})
