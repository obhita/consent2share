...
public class PepClientTest {
    ...
    public void setUp() throws Exception {
        ...
        address = String.format("http://localhost:%s/Pep/services/PepService", portNumber);
    ...
    public void testRegistryStoredQuery() throws Exception {
        AdhocQueryResponse resp = pepPortTypeImpl.registryStoredQuery(new AdhocQueryRequest());
    ...
    public void testRetrieveDocumentSet() throws Exception {
    	RetrieveDocumentSetResponse resp = pepPortTypeImpl.retrieveDocumentSet(new RetrieveDocumentSetRequest());
    ...
    public void testDirectEmailSend() throws Exception {
        DirectEmailSendResponse resp = pepPortTypeImpl.directEmailSend(new DirectEmailSendRequest());
    ...
    private PepPortType createPort() {
        ...
        final QName SERVICE = new QName("http://www.samhsa.gov/ds4ppilot/contract/pep", "PepService");

        PepPortType port = new PepService(WSDL_LOCATION, SERVICE).getXDSHTTPEndpoint();
