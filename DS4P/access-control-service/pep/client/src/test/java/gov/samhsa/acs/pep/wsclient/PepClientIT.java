...
public class PepClientIT {
	...
	public void testPep() throws Exception {
		...
		logger.debug("Retrieve Response: " + marshaller.marshall(retrieveDocResp));
	...
	private static AdhocQueryRequest constructAdhocQuery() throws Exception {
		...
		AdhocQueryRequest request = marshaller.unmarshallFromXml(AdhocQueryRequest.class, reqString);
	...
	private static RetrieveDocumentSetRequest constructRetrieveDocumentRequest(LinkedList<String> documentIds)
		...
		RetrieveDocumentSetRequest request = marshaller.unmarshallFromXml(RetrieveDocumentSetRequest.class,
				builder.toString());
