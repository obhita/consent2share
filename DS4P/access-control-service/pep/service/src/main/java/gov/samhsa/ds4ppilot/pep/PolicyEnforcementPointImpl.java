...
public class PolicyEnforcementPointImpl implements PolicyEnforcementPoint {
	 ...
	 * 
	 * @see
	 * gov.samhsa.ds4ppilot.pep.PolicyEnforcementPoint#registryStoredQuery(oasis
	 ...
	 * 
	 * @see
	 * gov.samhsa.ds4ppilot.pep.PolicyEnforcementPoint#retrieveDocumentSet(ihe
	 ...
	 * 
	 * @see
	 * gov.samhsa.ds4ppilot.pep.PolicyEnforcementPoint#directEmailSend(gov.samhsa
