...
public class SecuredPepImplTest {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(SecuredPepImplTest.class);
...
//
//		SecuredPepImpl securedOrchestrator = new SecuredPepImpl(
...
//
//		gov.samhsa.ds4ppilot.schema.securedpep.RetrieveDocumentSetResponse response = securedOrchestrator
...
//		securedOrchestrator.setResourceAction("Execute");
//
//		gov.samhsa.ds4ppilot.schema.securedpep.RegisteryStoredQueryResponse response = securedOrchestrator
