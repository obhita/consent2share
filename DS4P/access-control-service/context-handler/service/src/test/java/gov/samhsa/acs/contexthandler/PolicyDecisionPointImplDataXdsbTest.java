...
public class PolicyDecisionPointImplDataXdsbTest {
	...
	@InjectMocks
	PolicyDecisionPointImplDataXdsb policyDecisionPointImplDataXdsb;

	@Before
	public void setUp() {
		policyDecisionPointImplDataXdsb = new PolicyDecisionPointImplDataXdsb(
