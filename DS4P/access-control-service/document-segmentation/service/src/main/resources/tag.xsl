...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:function name="ds4p:getConfidentialityCodeByEntryId" as="xs:string">
        ...
        <xsl:variable name="confCodes" select="$ruleExecutionResponseContainer//executionResponse[child::entry[.=$entryId]]/impliedConfSection"/>
        <xsl:choose>
            <xsl:when test="$confCodes">
                <xsl:value-of select="ds4p:mapConfCodeFromNumtoChar(max(ds4p:mapConfCodeFromChartoNumber($confCodes)))"/>
            </xsl:when>
            <xsl:otherwise>
    ...
    <xsl:function name="ds4p:getConfidentialityCodeBySectionCode" as="xs:string">
        ...
        <xsl:variable name="confCodes" select="$ruleExecutionResponseContainer//executionResponse[child::c32SectionLoincCode[.=$sectionCode]][child::itemAction!='REDACT']/impliedConfSection"/>
        <xsl:value-of select="ds4p:mapConfCodeFromNumtoChar(max(ds4p:mapConfCodeFromChartoNumber($confCodes)))"/>
    </xsl:function>
    ...
    <xsl:function name="ds4p:getDocumentObligationCodeByEntryId" as="xs:string">
        <xsl:param name="entryId" />
        <xsl:variable name="temp" select="$ruleExecutionResponseContainer//executionResponse[child::entry[.=$entryId]]/documentObligationPolicy"/>
    ...
    <xsl:function name="ds4p:getDocumentRefrainCodeByEntryId" as="xs:string">
        <xsl:param name="entryId" />
        <xsl:variable name="temp" select="$ruleExecutionResponseContainer//executionResponse[child::entry[.=$entryId]]/documentRefrainPolicy"/>
        <xsl:value-of select="$temp[1]"/>
    </xsl:function>
    ...
    <xsl:template match="ClinicalDocument/confidentialityCode">
        <confidentialityCode code="{$documentConfidentialityCode}" codeSystem="2.16.840.1.113883.5.25" xmlns="urn:hl7-org:v3"/>
    </xsl:template>
    ...
    <xsl:template match="section[parent::component[parent::structuredBody]]">
        ...
        <xsl:variable name="sectionConfidentialityCode" select="ds4p:getConfidentialityCodeBySectionCode($sectionLoincCode)"/>
        <xsl:copy>
            ...
            <xsl:choose>
                <xsl:when test="$sectionConfidentialityCode">
                    <confidentialityCode code="{$sectionConfidentialityCode}" codeSystem="2.16.840.1.113883.5.25" xmlns="urn:hl7-org:v3"/>    
                </xsl:when>
                <xsl:otherwise>
    ...
    <xsl:template name="componentWithPrivacyAnnotation" xmlns="urn:hl7-org:v3" exclude-result-prefixes="#all">
        <xsl:variable name="conf" select="ds4p:getConfidentialityCodeByEntryId(../generatedEntryId/.)"/>
        <xsl:variable name="docRefrain" select="ds4p:getDocumentRefrainCodeByEntryId(../generatedEntryId/.)"/>
        <xsl:variable name="docObligation" select="ds4p:getDocumentObligationCodeByEntryId(../generatedEntryId/.)"/>        
    ...
    <xsl:template name="entryRelationshipWithPrivacyAnnotation" xmlns="urn:hl7-org:v3" exclude-result-prefixes="#all">
        <xsl:variable name="conf" select="ds4p:getConfidentialityCodeByEntryId(../generatedEntryId/.)"/>
        <xsl:variable name="docRefrain" select="ds4p:getDocumentRefrainCodeByEntryId(../generatedEntryId/.)"/>
        <xsl:variable name="docObligation" select="ds4p:getDocumentObligationCodeByEntryId(../generatedEntryId/.)"/>
        <xsl:if test="$conf or $docObligation or $docRefrain">
    ...
    <xsl:template name="organizerWithPrivacyAnnotation" xmlns="urn:hl7-org:v3" exclude-result-prefixes="#all">
        <xsl:param name="conf"/>
                ...
                <component typeCode="COMP">
                    <observation classCode="OBS" moodCode="DEF">
                        ...
                        <value xsi:type="CE" code="{$conf}" codeSystem="2.16.840.1.113883.5.1063"
                            ...
                            <originalText><xsl:value-of select="ds4p:mapConfCodeFromChartoText($conf)"/> Confidentiality</originalText>
                        </value>
                    </observation>
                </component>
            </xsl:if>
                ...
                <component typeCode="COMP">
                    <observation classCode="OBS" moodCode="DEF">
                        ...
                        <value xsi:type="CE" code="{$docObligation}"
                            ...
                            <originalText><xsl:value-of select="ds4p:mapDocObligationPolicyFromCodetoText($docObligation)"/></originalText>
                        </value>
                    </observation>
                </component>
            </xsl:if>
                ...
                <component typeCode="COMP">
                    <observation classCode="OBS" moodCode="DEF">
                        ...
                        <value xsi:type="CE" code="{$docRefrain}"
                            ...
                            <originalText><xsl:value-of select="ds4p:mapDocRefrainPolicyFromCodetoText($docRefrain)"/></originalText>
                        </value>
                    </observation>
                </component>
            </xsl:if>
