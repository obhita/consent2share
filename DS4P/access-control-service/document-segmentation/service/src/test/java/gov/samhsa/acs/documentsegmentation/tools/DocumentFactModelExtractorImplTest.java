...
public class DocumentFactModelExtractorImplTest {
	...
	public void testExtractFactModel_CCD_HITSP_C32_ALL_TemplateIdsAtRoot_Xml()
		...
		// Arrange
		String c32FileName = "CCD_HITSP_C32_ALL_TemplateIdsAtRoot.xml";
	...
	public void testExtractFactModel_CCD_HITSP_C32_HistoryAndMedications_WithAllR2Elements_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "CCD_HITSP_C32_HistoryAndMedications_WithAllR2Elements.xml";
	...
	public void testExtractFactModel_CCD_HITSP_C32_Medications_Template_Robust_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "CCD_HITSP_C32_Medications_Template_Robust.xml";
	...
	public void testExtractFactModel_CCD_HITSP_C32_Medications_Template_Small_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "CCD_HITSP_C32_Medications_Template_Small.xml";
	...
	public void testExtractFactModel_CCD_HITSP_C32_Minimal_NoSections_Valid_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "CCD_HITSP_C32_Minimal_NoSections_Valid.xml";
	...
	public void testExtractFactModel_CCD_HITSP_C32_Minimal_WithEntries_Valid_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "CCD_HITSP_C32_Minimal_WithEntries_Valid.xml";
	...
	public void testExtractFactModel_CCD_HITSP_C32_Minimal_WithSections_Valid_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "CCD_HITSP_C32_Minimal_WithSections_Valid.xml";
	...
	public void testExtractFactModel_CCD_HITSP_C32_v2_1_Examples_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "CCD_HITSP_C32_v2.1_Examples.xml";
	...
	public void testExtractFactModel_CCD_HITSP_C32_Valid_WithViolations_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "CCD_HITSP_C32_Valid_WithViolations.xml";
		List<String> ignoreList = new LinkedList<String>();
		ignoreList.add("EmbeddedClinicalDocument");
	...
	public void testExtractFactModel_CCD_Minimal_No_C32_templateIds_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "CCD_Minimal_No_C32_templateIds.xml";
	...
	public void testExtractFactModel_HITSP_C32v2_5_Rev0_CDAR2_Requirements_Only_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "HITSP_C32v2.5_Rev0_CDAR2_Requirements_Only.xml";
	...
	public void testExtractFactModel_HITSP_C32v2_5_Rev1_BaseC32_RequiredTemplateIds_NoErrors_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "HITSP_C32v2.5_Rev1_BaseC32_RequiredTemplateIds_NoErrors.xml";
	...
	public void testExtractFactModel_HITSP_C32v2_5_Rev2_BaseC32_RequiredContent_NoWarnings_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "HITSP_C32v2.5_Rev2_BaseC32_RequiredContent_NoWarnings.xml";
	...
	public void testExtractFactModel_HITSP_C32v2_5_Rev3_11Sections_NoEntries_EntryErrorsOnly_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "HITSP_C32v2.5_Rev3_11Sections_NoEntries_EntryErrorsOnly.xml";
	...
	public void testExtractFactModel_HITSP_C32v2_5_Rev4_11Sections_Entries_MinimalErrors_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "HITSP_C32v2.5_Rev4_11Sections_Entries_MinimalErrors.xml";
		List<String> ignoreList = new LinkedList<String>();
		ignoreList.add("EmbeddedClinicalDocument");
	...
	public void testExtractFactModel_HITSP_C32v2_5_Rev5_11Sections_Entries_MinimalWarnings_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "HITSP_C32v2.5_Rev5_11Sections_Entries_MinimalWarnings.xml";
		List<String> ignoreList = new LinkedList<String>();
		ignoreList.add("EmbeddedClinicalDocument");
	...
	public void testExtractFactModel_HITSP_C32v2_5_Rev6_16Sections_Entries_MinimalErrors_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "HITSP_C32v2.5_Rev6_16Sections_Entries_MinimalErrors.xml";
		List<String> ignoreList = new LinkedList<String>();
		ignoreList.add("EmbeddedClinicalDocument");
	...
	public void testExtractFactModel_JohnHalamkaCCDDocument_CCDonly_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "JohnHalamkaCCDDocument_CCDonly.xml";
		List<String> ignoreList = new LinkedList<String>();
		ignoreList.add("EmbeddedClinicalDocument");
	...
	public void testExtractFactModel_SegmentedDocumentContentProfileSample_Xml()
			throws IOException, SAXException {
		// Arrange
		String c32FileName = "SegmentedDocumentContentProfileSample.xml";
		List<String> ignoreList = new LinkedList<String>();
		ignoreList.add("EmbeddedClinicalDocument");
	...
	private void testFactModelExtraction(String c32FileName)
			throws IOException, SAXException {
		String cd = fileReader.readFile(SAMPLE_C32_LOCATION + c32FileName);
		String expectedFactModel = fileReader.readFile(SAMPLE_OUTPUT_LOCATION
				+ c32FileName);

		// Act
		String factModel = documentFactModelExtractor.extractFactModel(cd,
				xacmlResult);
	...
	private void testFactModelExtraction(String c32FileName, List<String> ignoreList)
			throws IOException, SAXException {
		String cd = fileReader.readFile(SAMPLE_C32_LOCATION + c32FileName);
		String expectedFactModel = fileReader.readFile(SAMPLE_OUTPUT_LOCATION
				+ c32FileName);
		...
		// Assert
		assertTrue(XmlComparator.compareXMLs(expectedFactModel, factModel, ignoreList).similar());
	}
}
