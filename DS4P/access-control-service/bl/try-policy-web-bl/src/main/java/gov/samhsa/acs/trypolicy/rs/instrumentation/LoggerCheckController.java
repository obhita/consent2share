package gov.samhsa.acs.trypolicy.rs.instrumentation;
...
public class LoggerCheckController {
	...
	public LoggerCheckController(String loggerInstrumentationKey, Optional<CXFLoggingConfigurer> cxfLoggingConfigurer) {
		super();
	...
	public String check(@QueryParam("instrumentationKey") String key) {
		...
		return  new StringBuilder("<p>This page is used for logging test. And if logback is the logging library, you can request this page serveral times to activate logback configuration changes.</p><hr/>")
		.append("<h3>Logger named [")
