...
public class ContextHandlerImplTest {
	...
	/**
	 * Test method for {@link gov.samhsa.ds4ppilot.orchestrator.contexthandler.ContextHandlerImpl#enforcePolicy(gov.samhsa.ds4ppilot.orchestrator.dto.XacmlRequest)}.
	 */
	@Test
