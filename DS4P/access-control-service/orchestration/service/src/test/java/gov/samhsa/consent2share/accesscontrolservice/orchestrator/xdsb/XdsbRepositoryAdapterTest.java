...
import gov.samhsa.ds4ppilot.orchestrator.XdsbMetadataGeneratorImpl;
...
public class XdsbRepositoryAdapterTest {
	...
	// Mocks
	@Mock
	private XdsbRepository xdsbRepositoryMock;
	@Mock
	...
	public void setUp() throws Exception {
		...
		XdsbRepositoryAdapter xdsbRepositoryAdapter = new XdsbRepositoryAdapter(
				xdsbRepositoryMock, marshallerMock);
		xdsbRepositoryAdapter
				.setXdsbMetadataGenerator(xdsbMetadataGeneratorMock);
	...
	public void testProvideAndRegisterDocumentSetRequest_Given_DocumentXml_HomeCommunityId()
		...
		when(xdsbRepositoryMock.provideAndRegisterDocumentSetRequest(request))
				.thenReturn(response);
		...
		RegistryResponse actualResponse = xdsbRepositoryAdapterSpy
				.provideAndRegisterDocumentSetRequest(DOCUMENT_XML_STRING,
	...
	public void testRetrieveDocumentSetRequest_Given_DocumentUniqueId_RepositoryId() {
		...
		// Act
		RetrieveDocumentSetResponse actualResponse = xdsbRepositoryAdapterSpy
				.retrieveDocumentSetRequest(DOCUMENT_XML_STRING,
						HOME_COMMUNITY_ID);
