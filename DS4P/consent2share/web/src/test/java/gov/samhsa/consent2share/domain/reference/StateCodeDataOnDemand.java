...
public class StateCodeDataOnDemand {
	...
	public void setCode(StateCode obj, int index) {
	...
	public void setCodeSystem(StateCode obj, int index) {
	...
	public void setCodeSystemName(StateCode obj, int index) {
	...
	public void setDisplayName(StateCode obj, int index) {
	...
	public void setOriginalText(StateCode obj, int index) {
	...
	public StateCode getSpecificStateCode(int index) {
        ...
        Long id = obj.getId();
        return stateCodeRepository.findOne(id);
    }
	...
	public void init() {
		int pageNumber = 0;
        int pageSize = 10;
        data = stateCodeRepository.findAll(
