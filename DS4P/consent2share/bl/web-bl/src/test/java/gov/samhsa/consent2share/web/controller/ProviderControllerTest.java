...
public class ProviderControllerTest {
	...
	public void before() throws AccessControlException {
		mockMvc = MockMvcBuilders.standaloneSetup(this.providerController)
				.build();
		...
		when(patientService.findPatientConnectionByUsername(anyString()))
				.thenReturn(patientConnectionDto);
		when(patientConnectionDto.getIndividualProviders()).thenReturn(
				individualProviders);
		when(patientConnectionDto.getOrganizationalProviders()).thenReturn(
				organizationalProviders);
	}

	@Test
	public void testConnectionMain() throws Exception {
		mockMvc.perform(get("/patients/connectionMain.html")).andExpect(
				view().name("views/patients/connectionMain"));
	}
	...
	public void testAjaxProviderSearch_Checked_Status_Is_OK() throws Exception {
		...
		mockMvc.perform(
				get("/patients/providerSearch.html").param("pageNumber", "0"))
	...
	public void testDeleteIndividualProvider() throws Exception {
		...
		when(individualProviderService.findIndividualProviderDto(anyLong()))
				.thenReturn(individualProviderDto);
		mockMvc.perform(
				post("/patients/connectionMain/deleteOrganizationalProvider")
						.param("organizationalProviderid", "ScrambledText"))
	...
	public void testDeleteOrganizationalProvider() throws Exception {
		...
		when(
				organizationalProviderService
						.findOrganizationalProviderDto(anyLong())).thenReturn(
	...
	public void testProviderSearchModel() throws Exception {
		...
		mockMvc.perform(get("/patients/connectionProviderAdd.html")).andExpect(
				view().name("views/patients/connectionProviderAdd"));
	}
	...
	public void testProviderSearchString() throws Exception {
		...
		mockMvc.perform(
				post("/patients/connectionProviderAdd.html").param("npi",
						"1234567890")).andExpect(
