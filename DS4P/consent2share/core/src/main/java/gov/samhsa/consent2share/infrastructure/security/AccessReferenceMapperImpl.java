...
public class AccessReferenceMapperImpl implements AccessReferenceMapper{
	...
	/* (non-Javadoc)
	 * @see gov.samhsa.consent2share.infrastructure.security.AccessReferenceMapper#getDirectReference(java.lang.String)
	 */
	@Override
	public long getDirectReference(String indirectReference) {
		...
		try {
			directReference = Long.parseLong((String) map.getDirectReference(indirectReference));
	...
	/* (non-Javadoc)
	 * @see gov.samhsa.consent2share.infrastructure.security.AccessReferenceMapper#setupAccessReferenceMap(java.lang.Iterable)
	 */
	@Override
	...
	AccessReferenceMap<String> getMap(){
		AccessReferenceMap<String> map=(AccessReferenceMap<String>) getSession().getAttribute(MAP_NAME);
		if(map==null)
