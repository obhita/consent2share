...
public class ConceptCodeServiceImplTest {
	...
	public void testfindId() throws ValueSetNotFoundException, ConceptCodeNotFoundException{
	...
	@Test(expected = ValueSetNotFoundException.class)
	public void testUpdateConceptCode_throw_ValueSetNotFoundException() throws ConceptCodeNotFoundException, ValueSetNotFoundException{
	...
	@Test
	public void testUpdateConceptCode2() throws ConceptCodeNotFoundException, ValueSetNotFoundException{
		...
		when(conceptCodeValueSetRepository.findAllByPkConceptCodeId(anyLong())).thenReturn(cValueSets);
		when(aCodeValueSet.getValueSet()).thenReturn(mock(ValueSet.class));
		
		when(aCodeValueSet.getValueSet().getId()).thenReturn((long)1);
		
		when(valueSetMgmtHelper.createConceptCodeDtoFromEntity(conceptCode)).thenReturn(updated);
		
		//assertEquals(vst.update(updated),updated);
	}
	
	@Test(expected = ValueSetNotFoundException.class)
	public void testUpdateConceptCode_throw_valueSetNotFoundException2() throws ConceptCodeNotFoundException, ValueSetNotFoundException{
	...
	public void testfindAll(){
		...
		List<ConceptCode> conceptCodes=(List<ConceptCode>)mock(List.class);
	...
	@Test(expected = ValueSetNotFoundException.class)
	public void testCreateCodeSystem_throw_ValueSetCategoryNotFoundException() throws ValueSetNotFoundException,
	...
	public void testCreateCodeSystem_throw_CodeSystemNotFoundException() throws ValueSetNotFoundException,
	CodeSystemVersionNotFoundException, CodeSystemNotFoundException {
		ConceptCodeVSCSDto conceptCodeVSCSDto=mock(ConceptCodeVSCSDto.class);
	...
	@Test(expected = CodeSystemNotFoundException.class)
	public void testCreateCodeSystemFromDto_throw_CodeSystemNotFoundException() throws ValueSetNotFoundException,
	...
	@Test(expected = ValueSetNotFoundException.class)
	public void testCreateCodeSystemFromDto_throw_ValueSetNotFoundException() throws ValueSetNotFoundException,
	CodeSystemNotFoundException, DuplicateConceptCodeException {
		ConceptCodeDto created = mock(ConceptCodeDto.class);
		...
		when(codeSystemVersionRepository
				.findOne(anyLong())).thenReturn(selectedCsv);
	...
	@Test(expected = ValueSetNotFoundException.class)
	public void testCreateCodeSystemFromDto_throw_ValueSetNotFoundException_2() throws ValueSetNotFoundException,
	CodeSystemNotFoundException, DuplicateConceptCodeException {
		ConceptCodeDto created = mock(ConceptCodeDto.class);
	...
	@Test
	public void testCreateCodeSystemFromDto_throw_ValueSetNotFoundException_3() throws ValueSetNotFoundException,
	CodeSystemNotFoundException, DuplicateConceptCodeException {
		ConceptCodeDto created = mock(ConceptCodeDto.class);
		...
		ConceptCode conceptCode = mock(ConceptCode.class);
		when(conceptCodeRepository.findByCodeAndCodeSystemVersionId(anyString(),anyLong())).thenReturn(conceptCode);
	...
	@Test
	public void testCreateCodeSystemFromDto_3() throws ValueSetNotFoundException,
	CodeSystemNotFoundException, DuplicateConceptCodeException {
		ConceptCodeDto created = mock(ConceptCodeDto.class);
		...
		ConceptCode conceptCode = mock(ConceptCode.class);
		when(conceptCodeRepository.findByCodeAndCodeSystemVersionId(anyString(),anyLong())).thenReturn(null);
