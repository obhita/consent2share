...
public class ClinicalDocumentServiceImplTest {
	...
	private String[] permittedExtensionsArray= {"txt","xml"};
	...
	public void testIsDocumentBelongedToThisUserWhenAuthenticationSucceds() {
		...
		List<ClinicalDocumentDto> clinicaldocumentDtos=Arrays.asList(patientsClinicalDocumentDto);
