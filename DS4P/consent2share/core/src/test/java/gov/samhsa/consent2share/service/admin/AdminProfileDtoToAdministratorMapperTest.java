...
public class AdminProfileDtoToAdministratorMapperTest {
	...
	@InjectMocks
	AdminProfileDtoToAdministratorMapper sut = new AdminProfileDtoToAdministratorMapper();
	...
	public void testMap_Given_Username(){
		...
		when(providerAdminRepository.findByUsername(username)).thenReturn(administrator);
