...
public class AccountVerificationServiceImplTest {
	...
	@Test(expected = IllegalArgumentException.class)
	public void testEnableAccount_When_Account_Verification_Dto_Is_Null() throws TokenNotExistException, TokenExpiredException, UsernameNotExistException, MessagingException {
		sut.enableAccount(null, "linkUrl");
	}
	
	@Test(expected = TokenNotExistException.class)
	public void testEnableAccount_Expired_Token() throws TokenNotExistException, TokenExpiredException, UsernameNotExistException, MessagingException {
