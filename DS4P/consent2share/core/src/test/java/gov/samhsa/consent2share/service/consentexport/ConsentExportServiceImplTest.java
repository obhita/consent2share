...
public class ConsentExportServiceImplTest {
	...
	public void testExportConsent2CDAR2() throws ConsentGenException {
		...
		when(consentBuilderMock.buildConsent2Cdar2(anyLong())).thenReturn(cdar2Mock);
	...
	@Test
	public void testExportConsent2CDAR2_ConsentGenException() throws  ConsentGenException {
		// Arrange
		thrown.expect(ConsentGenException.class);
		long consentId = 1;
		when(consentBuilderMock.buildConsent2Cdar2(anyLong())).thenThrow( new ConsentGenException("Error in export consent to cdar2"));
	...
	public void testExportConsent2XACML() throws ConsentGenException {
		...
		when(consentBuilderMock.buildConsent2Xacml(anyLong())).thenReturn(xacmlMock);
	...
	@Test
	public void testExportConsent2XACML_ConsentGenException() throws  ConsentGenException {
		// Arrange
		thrown.expect(ConsentGenException.class);
		long consentId = 1;
		when(consentBuilderMock.buildConsent2Xacml(anyLong())).thenThrow( new ConsentGenException("Error in export consent to cdar2"));
	...
	public void testExportConsent2XACML_Object() throws ConsentGenException {
		...
		String xacmlMock = "xacml";
		when(consentBuilderMock.buildConsent2Xacml(consent)).thenReturn(xacmlMock);
	...
	@Test
	public void testExportConsent2XACML_Object_ConsentGenException() throws  ConsentGenException {
		// Arrange
		thrown.expect(ConsentGenException.class);
		Consent consent = mock(Consent.class);
		when(consentBuilderMock.buildConsent2Xacml(consent)).thenThrow( new ConsentGenException("Error in export consent to cdar2"));
