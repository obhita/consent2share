package gov.samhsa.consent2share.showcase.web.instrumentation;
...
public class LoggerCheckController {
	...
	public @ResponseBody String check(@RequestParam("instrumentationKey") String key) {
	...
	public @ResponseBody String loggingInterceptors(@PathVariable("enabled") boolean enabled,  @RequestParam("instrumentationKey") String key){
