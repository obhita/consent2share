...
public class ProviderDto {
	...
	@ConstructorProperties({ "npi", "entityType", "providerEnumerationDate",
			"lastUpdateDate" })
	...
	public void setAuthorizedOfficialMiddleName(
			String authorizedOfficialMiddleName) {
	...
	public void setHealthcareProviderTaxonomy_1(
			String healthcareProviderTaxonomy_1) {
	...
	public String toString() {
		return "ProviderDto [npi=" + npi + ", entityType=" + entityType
				...
				+ healthcareProviderTaxonomy_1 + ", providerLicenseNumber_1="
