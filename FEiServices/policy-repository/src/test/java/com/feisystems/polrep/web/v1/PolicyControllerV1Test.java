...
public class PolicyControllerV1Test {

	private static final String API = "/rest/1";
	...
	@InjectMocks
	private PolicyControllerV1 sut;
	...
	@Test
	public void testGetPolicyCombiningAlgIds() throws Exception {
		// Arrange
		final String key1 = "key1";
		final String key2 = "key2";
		final String value1 = "value1";
		final String value2 = "value2";
		final String uri = API + "/policyCombiningAlgIds";
		...
		when(policyService.getPolicyCombiningAlgIds()).thenReturn(map);
		...
		// Assert
		verify(policyService, times(1)).getPolicyCombiningAlgIds();
	}
